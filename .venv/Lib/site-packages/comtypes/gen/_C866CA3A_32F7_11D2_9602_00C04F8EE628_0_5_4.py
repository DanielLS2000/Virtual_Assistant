...
__all__ = [
    'DISPID_SABIBufferSize', 'SVP_2', 'DISPID_SPRulesItem',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SGRSAddWordTransition',
    'ISpeechFileStream', 'ISpeechRecoResult', 'SPEI_SOUND_START',
    'eWORDTYPE_DELETED', 'DISPID_SRGetPropertyNumber', 'SITooSlow',
    'SRESoundEnd', 'SPEI_INTERFERENCE',
    'DISPID_SpeechObjectTokenCategory', 'SAFTGSM610_22kHzMono',
    'SPSFunction', 'SAFTDefault', 'SPINTERFERENCE_NOISE',
    'DISPID_SPEDisplayText', 'SPSNoun', 'DISPID_SpeechRecoContext',
    'SGRSTTRule', 'SRAImport', 'SPLO_STATIC', 'SPPHRASE',
    'SAFT24kHz16BitMono', 'SPWF_SRENGINE', 'SpFileStream',
    'SAFT48kHz16BitStereo', 'DISPID_SVVoice', 'SAFTADPCM_11kHzMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPIProperties',
    'DISPID_SRCreateRecoContext', 'STCInprocHandler',
    'DISPID_SpeechAudioStatus', 'DISPID_SPIEnginePrivateData',
    'DISPID_SOTCategory', 'SPPARTOFSPEECH',
    'SSSPTRelativeToCurrentPosition', 'SVP_21',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCEEnginePrivate',
    'SPEVENTSOURCEINFO', 'DISPID_SRRSetTextFeedback', 'IEnumString',
    'DISPID_SVSLastBookmark', 'SpeechGrammarTagDictation',
    'DISPID_SPRDisplayAttributes', 'SPCT_DICTATION',
    'DISPID_SpeechLexiconPronunciation',
    'SpeechPropertyLowConfidenceThreshold', 'SINoise', 'SP_VISEME_14',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpeechObjectToken', 'SPWORDTYPE',
    'STSF_CommonAppData', 'DISPID_SpeechPhraseElement',
    'SpMMAudioEnum', 'DISPID_SRRAlternates',
    'DISPID_SRSNumberOfActiveRules', 'SECFIgnoreCase', 'UINT_PTR',
    'DISPID_SAEventHandle', 'SpInprocRecognizer',
    'SpeechAudioProperties', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPRuleNumberOfElements', 'SPCATEGORYTYPE',
    'SDTPronunciation', 'SVSFParseAutodetect', 'SVEVoiceChange',
    'DISPID_SOTs_NewEnum', 'DISPID_SVStatus',
    'SpeechEmulationCompareFlags', 'SVEEndInputStream',
    'SpeechAudioState', 'DISPID_SGRSTText', 'DISPID_SABufferInfo',
    'SPEI_HYPOTHESIS', 'DISPID_SVGetAudioOutputs',
    'SpUnCompressedLexicon', 'SpeechAudioFormatGUIDWave',
    'SREInterference', 'SAFTCCITT_uLaw_11kHzMono', 'ISpRecoContext2',
    'DISPID_SVSpeak', 'DISPID_SRGetFormat',
    'DISPID_SVSInputWordPosition', 'ISpeechObjectTokens',
    'DISPID_SRRPhraseInfo', 'SVEViseme', 'ISpeechVoiceStatus',
    'DISPID_SVAudioOutput', 'SPRECOGNIZERSTATUS', 'SITooFast',
    'DISPID_SDKSetStringValue', 'SAFTADPCM_22kHzMono',
    'DISPID_SLGetGenerationChange', 'DISPID_SPACommit', 'SpStream',
    'SPWAVEFORMATTYPE', 'SPBINARYGRAMMAR', 'SWTDeleted',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SOTCDefault', 'SVP_14',
    'Speech_StreamPos_Asap', 'DISPID_SRGDictationUnload',
    'DISPID_SpeechWaveFormatEx', 'SPLO_DYNAMIC', 'SVSFVoiceMask',
    'ISpeechPhraseElement', 'DISPID_SPPEngineConfidence',
    'DISPID_SDKEnumKeys', 'SpNotifyTranslator',
    'ISpeechPhraseAlternate', 'DISPID_SPEPronunciation',
    'DISPID_SPPs_NewEnum', 'SAFT48kHz8BitStereo', 'ISpStreamFormat',
    'SpeechStreamFileMode', 'ISpXMLRecoResult', 'SLOStatic',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SLPPhoneIds',
    'DISPID_SRRTimes', 'SVP_5', 'STSF_AppData', 'SVP_3',
    'SPPHRASEPROPERTY', 'SREStateChange', 'ISpObjectToken',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPISaveToMemory',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpLexicon', 'SpCompressedLexicon',
    'DISPID_SVSpeakCompleteEvent', 'SpeechVoiceSpeakFlags',
    'DISPIDSPTSI', '_SPAUDIOSTATE', 'SREStreamStart',
    'SpeechFormatType', 'SAFTGSM610_11kHzMono', 'SPFM_OPEN_READWRITE',
    'DISPID_SOTRemoveStorageFileName', 'SLTUser',
    'DISPID_SVSInputSentenceLength', 'SP_VISEME_9',
    'SGPronounciation', 'WAVEFORMATEX', 'DISPID_SPERetainedSizeBytes',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFT12kHz8BitMono',
    'SpeechPropertyHighConfidenceThreshold', 'SPPS_Unknown',
    'DISPID_SRCEventInterests', 'DISPID_SGRSTsItem', 'SRERecognition',
    'SP_VISEME_13', 'SPEI_SR_AUDIO_LEVEL', 'SpeechTokenKeyAttributes',
    'ISpeechGrammarRuleState', 'SREAudioLevel', 'SPAUDIOOPTIONS',
    'DISPID_SOTDisplayUI', 'ISpAudio', 'SVP_11', 'ISpRecoContext',
    'SRTStandard', 'DISPID_SRGId', 'SVSFNLPSpeakPunc',
    'eLEXTYPE_PRIVATE9', 'SPWORDPRONUNCIATION', 'SVF_Stressed',
    'DISPID_SVEventInterests', 'SAFTText', 'DISPID_SPRFirstElement',
    'SpeechInterference', 'SPRST_ACTIVE', 'SPDKL_LocalMachine',
    'SVSFParseSapi', 'SPBO_NONE', 'DISPID_SpeechObjectToken',
    'SRSActiveAlways', 'SpeechEngineProperties', 'SRADynamic',
    'SPINTERFERENCE_TOOLOUD', 'ISpeechGrammarRule',
    'Speech_Default_Weight', 'SPSHT_OTHER', 'SAFTExtendedAudioFormat',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SBSRead',
    'SP_VISEME_17', 'SAFT22kHz16BitStereo', 'SVPAlert',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPERequiredConfidence', 'SREFalseRecognition',
    'DISPIDSPRG', 'SVEPhoneme', 'DISPID_SAFGuid',
    'SpeechEngineConfidence', 'SpeechRegistryUserRoot',
    'DISPID_SLPPartOfSpeech', 'SITooLoud', 'DISPID_SVSVisemeId',
    'DISPID_SVEViseme', 'SpeechStreamSeekPositionType',
    'DISPID_SPIGrammarId', 'DISPID_SGRsAdd', 'tagSPPROPERTYINFO',
    'SPCT_COMMAND', 'DISPID_SPRText', 'SPSHT_NotOverriden',
    'SpeechAllElements', 'DISPID_SPRuleFirstElement',
    'SDA_One_Trailing_Space', 'DISPID_SGRsCommit',
    'DISPID_SPRules_NewEnum', 'SpeechWordPronounceable',
    'DISPID_SLRemovePronunciationByPhoneIds', '__MIDL_IWinTypes_0009',
    'SASPause', 'SSSPTRelativeToStart', 'DISPID_SRGCmdSetRuleIdState',
    'SVSFUnusedFlags', 'DISPID_SRCERecognition',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechGrammarTagUnlimitedDictation', 'SAFTADPCM_8kHzMono',
    'SWTAdded', 'SECFEmulateResult', 'SAFT32kHz8BitStereo',
    'SPSInterjection', 'SAFT22kHz8BitStereo', 'DISPID_SPAs_NewEnum',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_MAX_TTS',
    'SAFT8kHz16BitStereo', 'SpSharedRecognizer',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPEAudioStreamOffset',
    'ISpeechRecoResultTimes', 'DISPID_SVESentenceBoundary',
    'DISPIDSPTSI_SelectionOffset', 'SPCT_SUB_DICTATION',
    'SAFT12kHz16BitStereo', 'DISPID_SpeechXMLRecoResult',
    'SGDSInactive', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechGrammarRules', 'DISPID_SGRs_NewEnum', 'SpeechWordType',
    'DISPID_SREmulateRecognition', 'tagSPTEXTSELECTIONINFO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SOTCId',
    '_ISpeechRecoContextEvents', 'SAFT22kHz8BitMono',
    'DISPID_SRRTTickCount', 'DISPID_SpeechPhraseReplacements',
    'SpeechMicTraining', 'DISPID_SRCCreateGrammar', 'SP_VISEME_1',
    'DISPID_SRIsShared', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISequentialStream', 'ISpeechRecoResultDispatch',
    'SpeechCategoryRecognizers', 'SECFIgnoreWidth', 'SPEI_MIN_SR',
    'DISPID_SGRSTPropertyName', 'DISPID_SVSCurrentStreamNumber',
    'SRESoundStart', 'DISPID_SRRAudio', 'SPAO_NONE',
    'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPWORDLIST',
    'DISPID_SRRAudioFormat', 'SPRST_INACTIVE', 'DISPID_SRRSpeakAudio',
    'SPPROPERTYINFO', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SOTCSetId', 'SpeechVoiceEvents', 'SAFT11kHz16BitMono',
    'SAFTADPCM_11kHzStereo', 'SpeechCategoryPhoneConverters',
    'DISPID_SOTCEnumerateTokens', 'SRAInterpreter',
    'SPAUDIOBUFFERINFO', 'DISPID_SMSADeviceId', 'eLEXTYPE_PRIVATE15',
    'SSTTDictation', 'SpeechTokenKeyFiles', 'SpeechRunState',
    'ISpeechPhraseProperties', 'SPRS_ACTIVE', 'SRCS_Enabled',
    'SPEI_TTS_PRIVATE', 'DISPID_SLWsCount',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SpeechMemoryStream',
    'SAFT44kHz8BitStereo', 'STSF_LocalAppData',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SLPsItem',
    'DISPID_SASCurrentSeekPosition', 'SpeechLexiconType',
    'SPAS_CLOSED', 'ISpEventSource', 'ISpProperties', 'SpVoice',
    'ISpPhoneticAlphabetSelection', 'ISpeechPhraseProperty',
    'SP_VISEME_3', 'SPWF_INPUT',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT22kHz16BitMono',
    'DISPID_SpeechPhraseProperty', 'SASStop', 'ISpeechXMLRecoResult',
    'SDKLCurrentUser', '_ISpeechVoiceEvents', 'SRTExtendableParse',
    'DISPID_SGRsItem', 'DISPID_SpeechRecoContextEvents',
    'eLEXTYPE_PRIVATE7', 'SGSEnabled', 'ISpeechRecognizer',
    'DISPID_SRGIsPronounceable', 'SPVPRI_ALERT',
    'SPDKL_DefaultLocation', 'SPBO_TIME_UNITS',
    'DISPID_SLRemovePronunciation', 'SPPHRASEELEMENT',
    'SPSEMANTICERRORINFO', 'DISPID_SRCEEndStream', 'SFTSREngine',
    'DISPID_SpeechFileStream', 'DISPID_SPCLangId',
    'DISPID_SDKOpenKey', 'SpMemoryStream', 'DISPID_SGRsDynamic',
    'DISPID_SGRAttributes', 'DISPID_SOTCreateInstance',
    'DISPID_SRAudioInput', 'SP_VISEME_2',
    'SpeechPropertyNormalConfidenceThreshold', 'SAFTGSM610_8kHzMono',
    'DISPID_SWFEChannels', 'DISPID_SPELexicalForm',
    'DISPID_SVEAudioLevel', 'SVP_20', 'DISPID_SRRecognizer',
    'SpeechBookmarkOptions', 'SAFTCCITT_ALaw_8kHzMono',
    'ISpGrammarBuilder', 'SPPS_Function', 'DISPID_SGRSTWeight',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPPFirstElement', 'SPSHORTCUTTYPE', 'SP_VISEME_11',
    'DISPID_SpeechPhraseRules', 'SPEI_END_INPUT_STREAM',
    'SPFM_OPEN_READONLY', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRCEInterference', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SGRAddResource', 'DISPID_SABIMinNotification',
    'DISPID_SRGetPropertyString', 'SREAdaptation',
    'SSSPTRelativeToEnd', 'SPEI_MAX_SR', 'SRSActive',
    'eWORDTYPE_ADDED', 'SPEI_START_INPUT_STREAM', 'SP_VISEME_18',
    'SWPUnknownWordPronounceable', 'DISPID_SPIElements',
    'SPLEXICONTYPE', 'DISPID_SPEAudioSizeBytes', 'SpResourceManager',
    'SpPhraseInfoBuilder', 'DISPID_SRGCommit',
    'SpeechGrammarTagWildcard', 'SPBO_AHEAD',
    'DISPID_SRCRetainedAudioFormat', 'SPVPRI_NORMAL',
    'SAFT44kHz16BitMono', 'SpWaveFormatEx',
    'DISPID_SRGDictationSetState', 'DISPID_SPIAudioStreamPosition',
    'SPPHRASERULE', 'SpShortcut', 'SpeechUserTraining', 'SDTAudio',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPRNumberOfElements',
    'DISPID_SASCurrentDevicePosition', 'SPRS_INACTIVE',
    'DISPID_SRCEAdaptation', 'eLEXTYPE_PRIVATE11',
    'DISPID_SPCPhoneToId', 'eLEXTYPE_MORPHOLOGY',
    'SpeechAddRemoveWord', 'SDTAlternates', 'eLEXTYPE_PRIVATE18',
    'ISpRecoGrammar2', 'ISpStreamFormatConverter',
    'DISPID_SVEStreamStart', 'DISPID_SRCESoundEnd', 'SVP_6',
    'SPEI_REQUEST_UI', 'DISPID_SMSALineId',
    'DISPID_SpeechRecoResult2', 'SpeechRecognitionType',
    'DISPID_SPEEngineConfidence', 'SpeechTokenIdUserLexicon',
    'DISPID_SVSkip', 'ISpeechWaveFormatEx', 'DISPID_SOTRemove',
    'SpeechLoadOption', 'SRTSMLTimeout', 'DISPID_SBSWrite',
    'eLEXTYPE_RESERVED6', 'SpObjectToken', 'SRTReSent',
    'SPGRAMMARSTATE', 'DISPID_SRSetPropertyString', 'DISPID_SPAsItem',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPPsItem', 'SpNullPhoneConverter',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SLPs_NewEnum', 'SBOPause', 'SPAS_RUN',
    'SpeechSpecialTransitionType', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPIStartTime', 'ISpeechLexiconPronunciation',
    'SRCS_Disabled', 'SPAR_Low', 'DISPID_SRCESoundStart',
    'DISPID_SPIGetText', 'ISpeechLexiconWords', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRId', 'ISpeechLexiconWord', 'DISPID_SVEPhoneme',
    'SVP_16', 'SpeechPartOfSpeech', 'SSFMCreate', 'SPWT_LEXICAL',
    'SPEI_VISEME', 'DISPID_SOTGetDescription', 'SRAExport',
    'SAFTADPCM_44kHzMono', 'DISPID_SpeechLexiconProns',
    '_RemotableHandle', 'SVP_10', 'SPEI_PHONEME',
    'ISpNotifyTranslator', 'ISpeechPhraseElements', 'SpMMAudioIn',
    'DISPID_SPAPhraseInfo', 'SPSEMANTICFORMAT', 'SPFILEMODE',
    'DISPID_SPIReplacements', 'DISPID_SOTIsUISupported',
    'DISPID_SRRTStreamTime', 'DISPID_SPPsCount',
    'ISpeechPhraseAlternates', 'ISpeechPhraseInfoBuilder',
    'eLEXTYPE_PRIVATE19', 'DISPID_SpeechBaseStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVF_Emphasis',
    'ISpeechTextSelectionInformation', 'SP_VISEME_21',
    'DISPID_SRCResume', 'SPAUDIOSTATUS', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SLWs_NewEnum', 'DISPIDSPTSI_ActiveOffset', 'SVPOver',
    'DISPID_SVSLastStreamNumberQueued', 'SPPS_NotOverriden',
    'SAFT12kHz16BitMono', 'SpStreamFormatConverter', 'SASClosed',
    'SPEVENT', 'DISPID_SPEsItem', 'DISPID_SpeechLexiconWord',
    'ISpObjectWithToken', 'DISPID_SGRsCount',
    'SGDSActiveUserDelimited', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SCSBaseStream', 'SAFT44kHz16BitStereo',
    'DISPID_SpeechObjectTokens', 'SSFMOpenForRead',
    'DISPID_SRGCmdLoadFromResource', 'SVSFParseMask',
    'DISPID_SRCEBookmark', 'DISPID_SGRSRule',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPRsCount',
    'ISpeechPhraseReplacement', 'ISpStream', 'DISPID_SVWaitUntilDone',
    ...
    'SPSERIALIZEDRESULT', 'eLEXTYPE_RESERVED4',
    'DISPID_SPIAudioSizeTime', 'DISPID_SGRSAddRuleTransition',
    'ISpeechDataKey', 'SGSDisabled', 'SVEStartInputStream',
    'SSFMOpenReadWrite', 'SpObjectTokenCategory',
    'SGLexicalNoSpecialChars', 'SREAllEvents', 'DISPID_SVVolume',
    'SDKLLocalMachine', 'SVP_0', 'DISPID_SPPConfidence',
    'DISPID_SRRRecoContext', 'SPEI_UNDEFINED', 'SPSHT_EMAIL',
    'DISPID_SPEsCount', 'DISPID_SAVolume', 'DISPID_SRGDictationLoad',
    'DISPID_SPPParent', 'DISPID_SRCEPhraseStart',
    'DISPID_SPPChildren', 'SAFT16kHz16BitStereo',
    'DISPID_SGRAddState', 'SpeechVoicePriority', 'SSTTWildcard',
    'DISPID_SVIsUISupported', 'SPEI_FALSE_RECOGNITION', 'SRATopLevel',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRRTOffsetFromStart', 'SPPS_Modifier', 'ISpShortcut',
    'DISPID_SpeechRecoResult', 'DISPID_SRCERequestUI', 'SP_VISEME_0',
    'SVP_12', 'Speech_StreamPos_RealTime', 'DISPID_SVSRunningState',
    'DISPID_SRCEPropertyStringChange', 'SpeechCategoryVoices',
    'DISPID_SVRate', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SpeechPhraseElements', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SGRSTsCount', 'SRSInactiveWithPurge',
    'DISPID_SOTGetStorageFileName', 'SPSERIALIZEDPHRASE',
    'ISpPhoneConverter', 'SPEI_WORD_BOUNDARY',
    'SAFTCCITT_ALaw_11kHzStereo', 'SRTEmulated', 'ISpSerializeState',
    'SAFT16kHz8BitStereo', 'SVSFlagsAsync', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRCEFalseRecognition', 'eLEXTYPE_PRIVATE12',
    'SREPropertyStringChange', 'DISPID_SpeechPhraseRule',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SLAddPronunciation',
    'SPSHORTCUTPAIRLIST', 'SPRECOSTATE', 'DISPID_SPRs_NewEnum',
    'SpeechTokenKeyUI', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SLGenerationId', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechDataKey', 'SDTAll', 'SAFT12kHz8BitStereo',
    'SPWT_PRONUNCIATION', 'DISPID_SPAsCount',
    'DISPID_SVSInputWordLength', 'SPPS_Noncontent', 'SpMMAudioOut',
    'DISPID_SWFEAvgBytesPerSec', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SOTGetAttribute', 'SREPropertyNumChange',
    'DISPID_SAStatus', 'SPPHRASEREPLACEMENT', 'DISPID_SBSSeek',
    'DISPID_SVResume', 'SpeechGrammarState', 'SPGS_DISABLED',
    'IInternetSecurityManager', 'SpeechTokenContext',
    'eLEXTYPE_PRIVATE1', 'DISPID_SLGetPronunciations',
    'DISPID_SGRSTPropertyId', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SDKGetlongValue', 'SAFT11kHz8BitStereo',
    'DISPID_SWFEBlockAlign', 'ISpEventSink',
    'SAFTCCITT_ALaw_22kHzStereo', 'SAFTADPCM_44kHzStereo',
    'DISPID_SRIsUISupported', 'SVP_13', 'SPSModifier',
    'DISPID_SVEWord', 'SPRULESTATE', 'SVP_8', 'SPEI_END_SR_STREAM',
    'SECFIgnoreKanaType', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRRSaveToMemory', 'DISPID_SPRuleName', 'SPAS_PAUSE',
    'ISpPhrase', 'DISPID_SOTMatchesAttributes', 'SREPhraseStart',
    'SPFM_NUM_MODES', 'SREHypothesis', 'SPRECORESULTTIMES',
    'DISPID_SRCEHypothesis', 'SPEI_TTS_BOOKMARK', 'SpeechVisemeType',
    'SAFT32kHz16BitStereo', 'SPEI_RESERVED5',
    'ISpeechGrammarRuleStateTransition', 'SpeechRecoEvents',
    'DISPID_SVAudioOutputStream', 'SPPS_Interjection',
    'SpeechCategoryAudioOut', 'SRSEIsSpeaking', 'DISPID_SVGetVoices',
    'DISPID_SRCSetAdaptationData', 'SRAORetainAudio',
    'SpeechDisplayAttributes', 'DISPID_SRSCurrentStreamNumber',
    'IEnumSpObjectTokens', 'DISPID_SLWPronunciations', 'SGSExclusive',
    'ISpeechAudioStatus', 'SGLexical', 'SpeechVisemeFeature',
    'SpeechCategoryAppLexicons', 'SDTLexicalForm', 'SRERequestUI',
    'DISPID_SRCBookmark', 'DISPID_SRStatus', 'DISPID_SVSpeakStream',
    'SpTextSelectionInformation', 'SP_VISEME_12',
    'SAFT8kHz8BitStereo', 'SpSharedRecoContext', 'SVSFIsFilename',
    'SPBO_PAUSE', 'SPAS_STOP', 'SPWT_DISPLAY', 'DISPID_SDKEnumValues',
    'ISpeechPhraseRule', 'DISPID_SDKCreateKey',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPRuleParent',
    'SPPS_RESERVED4', 'SPCS_ENABLED', 'DISPID_SpeechGrammarRules',
    'SSFMCreateForWrite', 'SVEPrivate', 'SpPhoneticAlphabetConverter',
    'DISPID_SVAlertBoundary', 'DISPID_SMSSetData',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpRecoCategory',
    'DISPID_SRCRecognizer', 'SpeechRecognizerState',
    'DISPID_SRSAudioStatus', 'SAFTTrueSpeech_8kHz1BitMono',
    'SWPUnknownWordUnpronounceable', 'SRAONone', 'SPSTREAMFORMATTYPE',
    'SAFT32kHz16BitMono', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFT24kHz16BitStereo', 'SVEAllEvents', 'SECNormalConfidence',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SGRsFindRule', 'SPSVerb',
    'DISPID_SPILanguageId', 'SPEI_RESERVED3', 'SpeechTokenValueCLSID',
    'SpeechCategoryAudioIn', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCVoice', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRCCmdMaxAlternates', 'SAFT48kHz8BitMono',
    'ISpNotifySink', 'DISPID_SpeechAudio', 'ISpeechPhraseInfo',
    'ISpResourceManager', 'SPEI_RESERVED1', 'SECFDefault',
    'SPBOOKMARKOPTIONS', 'LONG_PTR', 'DISPID_SABufferNotifySize',
    'SAFT8kHz8BitMono', 'ISpeechLexiconPronunciations',
    'DISPID_SGRSTPropertyValue', 'ISpNotifySource',
    'DISPID_SLWLangId', 'DISPID_SDKDeleteKey', 'DISPID_SRGReset',
    'SPEI_MIN_TTS', 'eLEXTYPE_PRIVATE8', 'DISPID_SRAudioInputStream',
    'SPSUnknown', 'DISPID_SASNonBlockingIO', 'SVP_4', 'SPRULE',
    'eLEXTYPE_PRIVATE13', 'DISPID_SVSLastBookmarkId',
    'SAFT24kHz8BitStereo', 'DISPID_SpeechLexicon',
    'DISPID_SpeechCustomStream', 'SP_VISEME_5', 'DISPID_SMSGetData',
    'SPAO_RETAIN_AUDIO', 'SREPrivate', 'SpeechDataKeyLocation',
    'DISPID_SLWType', 'SDTReplacement', 'DISPID_SRRTLength',
    'DISPID_SBSFormat', 'SPSLMA', 'SP_VISEME_8', 'SPDKL_CurrentUser',
    'DISPID_SVDisplayUI', 'SDTDisplayText', 'SRTAutopause', 'SDTRule',
    'SLTApp', 'ISpeechMMSysAudio', 'DISPID_SRCRequestedUIType',
    'SPGS_EXCLUSIVE', 'ISpeechObjectTokenCategory',
    'eLEXTYPE_PRIVATE2', 'ISpVoice', 'SPAR_High', 'DISPID_SLWWord',
    'DISPID_SPCIdToPhone', 'DISPID_SOTDataKey',
    'DISPID_SpeechRecognizer', 'SVSFDefault',
    'DISPID_SpeechPhraseAlternate', 'eLEXTYPE_PRIVATE14',
    'DISPID_SDKGetBinaryValue', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechVoice', 'DISPID_SGRSTRule', 'SGRSTTWildcard',
    'SPEI_RECOGNITION', 'eLEXTYPE_USER', 'SVEWordBoundary',
    'Speech_Max_Pron_Length', 'DISPID_SLPType',
    'SpeechAudioFormatType', 'ISpeechAudioBufferInfo', 'DISPID_SPPId',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SVEVoiceChange', 'SVP_15', 'DISPID_SVSLastResult',
    'DISPID_SLGetWords', 'ISpeechRecognizerStatus', 'SPINTERFERENCE',
    'DISPID_SpeechPhraseProperties', 'SPAR_Unknown', 'SPEVENTENUM',
    'DISPID_SRRDiscardResultInfo', 'ISpeechPhraseReplacements',
    'DISPID_SADefaultFormat', 'ISpeechRecoContext', 'ISpRecognizer2',
    'SVSFPurgeBeforeSpeak', 'DISPID_SGRSTransitions',
    'DISPID_SDKDeleteValue', 'SPXRO_SML', 'SINone',
    'DISPID_SRGSetWordSequenceData', 'SVSFPersistXML', 'ISpeechAudio',
    'ISpMMSysAudio', 'DISPID_SGRSTType', 'ISpeechRecoGrammar',
    'SpeechRuleAttributes', 'SPEI_START_SR_STREAM',
    'DISPID_SPANumberOfElementsInResult', 'SFTInput',
    'DISPIDSPTSI_SelectionLength', 'SPDKL_CurrentConfig',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRGRules', 'ISpDataKey',
    'DISPID_SVEBookmark', 'SECHighConfidence',
    'DISPID_SpeechPhoneConverter', 'SPEI_SR_BOOKMARK',
    'SPPS_RESERVED2', 'SVP_18', 'SPINTERFERENCE_NONE', 'ISpPhraseAlt',
    'SRERecoOtherContext', 'DISPID_SVEEnginePrivate',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SOTsCount',
    'SAFT44kHz8BitMono', 'SpeechRecoProfileProperties',
    'DISPID_SpeechVoiceStatus', 'ISpeechLexicon', 'ISpRecoGrammar',
    'SPPS_LMA', 'SDTProperty', 'SPEI_SR_PRIVATE',
    'ISpeechPhraseRules', 'SAFTCCITT_uLaw_44kHzStereo',
    'eLEXTYPE_PRIVATE20', 'DISPID_SFSClose', 'SP_VISEME_6',
    'SPCS_DISABLED', 'SPDATAKEYLOCATION', 'eLEXTYPE_RESERVED7',
    'SDA_Two_Trailing_Spaces', 'SpeechPropertyResourceUsage',
    'SP_VISEME_10', 'SVP_17', 'SpeechAudioFormatGUIDText', 'SVP_9',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRDisplayUI', 'DISPID_SLPsCount',
    'SREStreamEnd', 'SRARoot', 'ISpeechCustomStream',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPEI_SOUND_END',
    'DISPID_SpeechLexiconWords', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SGRsCommitAndSave', 'SPRST_INACTIVE_WITH_PURGE',
    'SPEI_PHRASE_START', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SRGState', 'eLEXTYPE_APP', 'SDKLCurrentConfig',
    'DISPID_SRState', 'DISPID_SpeechAudioFormat', 'SGDSActive',
    'DISPID_SRGSetTextSelection', 'DISPID_SRGRecoContext',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVPause',
    'eLEXTYPE_PRIVATE10', 'SASRun', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechGrammarWordType', 'SpInProcRecoContext',
    'DISPID_SRSClsidEngine', 'DISPID_SPEDisplayAttributes',
    'DISPIDSPTSI_ActiveLength', 'SP_VISEME_4', 'DISPID_SPRuleId',
    'DISPID_SPEs_NewEnum', 'DISPID_SPPName',
    'DISPID_SRCEPropertyNumberChange',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpeechRecoContextState',
    'DISPID_SPPValue', 'SRSInactive', 'DISPID_SRCPause',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SWFEExtraData',
    'DISPID_SMSAMMHandle', 'DISPID_SWFEFormatTag',
    'IInternetSecurityMgrSite', 'SPLOADOPTIONS', 'SPEI_RESERVED6',
    'SPEI_RESERVED2', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechMMSysAudio',
    'DISPID_SpeechGrammarRule', 'eLEXTYPE_PRIVATE6',
    'DISPID_SPAStartElementInResult', 'ISpeechResourceLoader',
    'SP_VISEME_15', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFT48kHz16BitMono', 'DISPID_SPEAudioSizeTime',
    'SAFT8kHz16BitMono', 'ISpeechVoice', 'STCAll',
    'SAFTGSM610_44kHzMono', 'DISPID_SPIRule', 'SPEI_VOICE_CHANGE',
    'SGRSTTDictation', 'SPSNotOverriden', 'DISPID_SPRuleConfidence',
    'SPSHORTCUTPAIR', 'SDKLDefaultLocation', 'SVEBookmark',
    'DISPID_SASState', 'SAFTNoAssignedFormat', 'SPTEXTSELECTIONINFO',
    'STCLocalServer', 'SPFM_CREATE_ALWAYS', 'DISPID_SOTsItem',
    'ISpRecognizer', 'DISPID_SOTId', 'SpeechCategoryRecoProfiles',
    'ISpRecoResult', 'DISPID_SVEStreamEnd', 'SPGS_ENABLED',
    'SP_VISEME_7', 'eLEXTYPE_PRIVATE17', 'DISPID_SLPLangId',
    'DISPID_SRCERecognitionForOtherContext', 'SPXRO_Alternates_SML',
    'SPPS_SuppressWord', 'eLEXTYPE_USER_SHORTCUT', 'STSF_FlagCreate',
    'DISPID_SPEActualConfidence', 'SGRSTTTextBuffer',
    'ISpeechRecoResult2', 'DISPID_SDKGetStringValue',
    'DISPID_SRCRetainedAudio', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SFSOpen',
    'SAFT24kHz8BitMono', 'DISPID_SpeechRecognizerStatus',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPSHT_Unknown',
    'DISPID_SRCState', 'ISpeechAudioFormat', 'DISPID_SDKSetLongValue',
    'SVSFParseSsml', 'SPEI_ADAPTATION', 'DISPID_SPIEngineId',
    'SPWORD', 'DISPID_SPRuleChildren', 'DISPID_SDKSetBinaryValue',
    'SPEI_TTS_AUDIO_LEVEL', 'SGRSTTWord', 'DISPID_SVSPhonemeId',
    'SAFTNonStandardFormat', 'SPEI_PROPERTY_STRING_CHANGE',
    'SVSFIsXML', 'DISPID_SGRClear', 'SPEI_RECO_STATE_CHANGE',
    'SVSFIsNotXML', 'DISPID_SPERetainedStreamOffset',
    'SpeechGrammarRuleStateTransitionType', 'SECLowConfidence',
    'SPVISEMES', 'SPSMF_UPS', 'SREBookmark', 'SpCustomStream',
    'DISPID_SGRInitialState', 'SpeechRetainedAudioOptions',
    'DISPID_SVGetAudioInputs', 'STCRemoteServer', 'SpeechDiscardType',
    'SPPS_RESERVED1', 'DISPID_SPPNumberOfElements', 'SSTTTextBuffer',
    'SPEI_SR_RETAINEDAUDIO', 'SVEAudioLevel', 'SpeechAudioVolume',
    'SLODynamic', 'SVESentenceBoundary', 'SPVPRIORITY',
    'DISPID_SWFEBitsPerSample', 'SPRST_NUM_STATES', 'SPPS_Noun',
    'tagSTATSTG', 'SRSEDone', 'SAFT32kHz8BitMono', 'STCInprocServer',
    'SpeechDictationTopicSpelling', 'SVP_7', 'DISPID_SVGetProfiles',
    'SRADefaultToActive', 'SVF_None', 'DISPID_SRCEAudioLevel',
    'SPSSuppressWord', 'SGRSTTEpsilon', 'SPCT_SUB_COMMAND',
    'SpAudioFormat', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SpeechGrammarRuleState', 'SVSFNLPMask',
    'DISPID_SPARecoResult', 'DISPID_SPRuleEngineConfidence',
    'SGDSActiveWithAutoPause', 'SpPhoneConverter',
    'eLEXTYPE_RESERVED9', 'DISPID_SGRName', 'DISPID_SAFType',
    'SPPS_Verb', 'DISPID_SABIEventBias', 'ISpeechBaseStream',
    'DISPID_SASFreeBufferSpace', 'SAFT16kHz8BitMono',
    'DISPID_SPIAudioSizeBytes', 'SPVOICESTATUS', 'eLEXTYPE_RESERVED8',
    'IStream', 'DISPID_SOTCGetDataKey', 'ISpeechMemoryStream',
    'SpeechRuleState', 'DISPID_SpeechAudioBufferInfo',
    'SAFT16kHz16BitMono', 'DISPID_SLPSymbolic',
    'ISpPhoneticAlphabetConverter', 'SITooQuiet', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCERecognizerStateChange', 'SPPS_RESERVED3',
    'SpeechTokenShellFolder', 'DISPID_SASetState', 'SVP_19',
    'eLEXTYPE_PRIVATE4', 'SVPNormal', 'SWPKnownWordPronounceable',
    'ISpRecognizer3', 'SPFM_CREATE', 'SPCT_SLEEP', 'DISPID_SLWsItem',
    'SP_VISEME_16', 'SECFNoSpecialChars', 'SINoSignal',
    'DISPID_SRProfile', 'DISPID_SRGCmdSetRuleState', 'SPVPRI_OVER',
    'DISPID_SPRsItem', 'SP_VISEME_19', 'eLEXTYPE_PRIVATE16',
    'SPAR_Medium', 'ISpObjectTokenCategory', 'SBONone',
    'DISPID_SRRGetXMLResult', 'DISPID_SGRSTNextState',
    'DISPID_SOTSetId', 'DISPID_SRGetRecognizers',
    'SpeechPropertyResponseSpeed', 'DISPID_SWFESamplesPerSec',
    'SDA_Consume_Leading_Spaces', 'SPGRAMMARWORDTYPE',
    'eLEXTYPE_RESERVED10', 'DISPID_SRCEStartStream',
    'SPINTERFERENCE_TOOQUIET', 'Speech_Max_Word_Length',
    'SAFT11kHz16BitStereo', 'SPAUDIOSTATE',
    'DISPID_SVSInputSentencePosition', 'SPWORDPRONUNCIATIONLIST',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPRulesCount', 'SVP_1',
    'SpLexicon', 'SP_VISEME_20', 'DISPID_SpeechPhraseInfo',
    'DISPID_SVPriority', 'SPEI_SENTENCE_BOUNDARY', 'SPCONTEXTSTATE',
    'ISpeechPhoneConverter', 'SGDisplay'
]
