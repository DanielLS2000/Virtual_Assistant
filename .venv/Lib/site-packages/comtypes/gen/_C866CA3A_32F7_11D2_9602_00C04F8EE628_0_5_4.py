...
__all__ = [
    'SDTAlternates', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRGetFormat', 'SPTEXTSELECTIONINFO',
    'SREStreamStart', 'DISPID_SPRuleParent', 'SPRST_ACTIVE_ALWAYS',
    'SpeechVoiceEvents', 'SSFMOpenForRead',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SVEEnginePrivate',
    'DISPID_SPERetainedSizeBytes', 'SPSNoun',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SDKGetBinaryValue',
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechVoice', 'SGRSTTDictation',
    'DISPID_SpeechGrammarRule', 'SPSNotOverriden', 'SDTDisplayText',
    'DISPID_SMSGetData', 'DISPID_SAVolume', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCEHypothesis', 'ISpeechPhraseReplacement',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVVolume',
    'SpeechPartOfSpeech', 'DISPID_SOTRemove', 'SPEI_ADAPTATION',
    'ISpeechRecoGrammar', 'Speech_StreamPos_RealTime', 'SVSFDefault',
    'SPWT_LEXICAL', 'SpUnCompressedLexicon',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPPNumberOfElements',
    'SpSharedRecoContext', 'DISPID_SRSAudioStatus',
    'DISPID_SOTDataKey', 'SREFalseRecognition',
    'DISPID_SPEActualConfidence', 'DISPID_SVSRunningState',
    'ISpNotifySource', 'DISPID_SVEBookmark', 'ISpeechAudioStatus',
    'SP_VISEME_1', 'ISpeechLexiconPronunciations', 'SPRULESTATE',
    'DISPID_SOTGetAttribute', 'DISPID_SRCCreateResultFromMemory',
    'ISpObjectToken', 'DISPID_SPCLangId', 'SAFT8kHz16BitMono',
    'DISPID_SRGReset', 'SAFT48kHz8BitStereo', 'SpMMAudioIn',
    'SpeechPropertyComplexResponseSpeed', 'SAFT16kHz8BitStereo',
    'SPFM_OPEN_READWRITE', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SGRSTPropertyId', 'DISPID_SVSVisemeId',
    'DISPID_SPACommit', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechAudioStatus', 'SpeechPropertyResponseSpeed',
    'DISPID_SLWPronunciations', 'SpeechTokenValueCLSID',
    'ISpNotifySink', 'DISPID_SPISaveToMemory', 'SSTTWildcard',
    'SRSActiveAlways', 'SDA_No_Trailing_Space', 'SRATopLevel',
    'DISPID_SOTCEnumerateTokens', 'SAFTDefault',
    'DISPID_SpeechPhraseElement', 'DISPID_SPEs_NewEnum',
    'SVSFNLPMask', 'DISPID_SRCEPropertyStringChange',
    'SPFM_NUM_MODES', 'SVP_4', 'SAFT22kHz16BitStereo',
    'DISPID_SVEVoiceChange', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPARecoResult', 'SVP_7', 'ISpeechPhraseRules',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'eLEXTYPE_PRIVATE7',
    'eLEXTYPE_PRIVATE10', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechRecoContext', 'ISpStreamFormatConverter',
    '_SPAUDIOSTATE', 'SPFILEMODE', 'DISPID_SPCIdToPhone',
    'SVSFPersistXML', 'ISpeechPhraseRule', 'STCRemoteServer',
    'SSFMCreate', 'DISPID_SDKSetStringValue', 'SpeechFormatType',
    'ISpEventSource', 'SECLowConfidence', 'SPEVENTENUM',
    'SP_VISEME_20', 'SVP_0', 'SPSHT_OTHER', 'eLEXTYPE_APP',
    'SpMMAudioEnum', 'SPLO_DYNAMIC', 'eLEXTYPE_RESERVED7',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpGrammarBuilder',
    'DISPID_SRCEPhraseStart', 'DISPID_SOTCGetDataKey',
    'SSTTTextBuffer', 'ISpeechRecoResult',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechAudioFormat',
    'SDTAll', 'SpStream', 'DISPID_SpeechMMSysAudio',
    'SpeechRuleState', 'eWORDTYPE_ADDED', 'SVEWordBoundary',
    'SPWORDTYPE', 'DISPID_SVESentenceBoundary',
    'DISPID_SPRFirstElement', 'SpPhraseInfoBuilder', 'DISPIDSPRG',
    'DISPID_SLPsItem', 'ISpeechPhraseAlternates',
    'DISPID_SpeechAudioFormat', 'SAFT24kHz8BitMono',
    'SAFTGSM610_8kHzMono', 'SVP_8', 'SPEI_MIN_SR',
    'SpeechDisplayAttributes', 'STCLocalServer', 'SPVPRIORITY',
    'DISPID_SVResume', 'SVP_21', 'DISPID_SPPBRestorePhraseFromMemory',
    'SP_VISEME_11', 'SINoSignal', 'DISPID_SRCEventInterests',
    'DISPID_SRCEEnginePrivate', 'SPLEXICONTYPE', 'SGRSTTWildcard',
    'SPAS_CLOSED', 'SVF_Stressed', 'SP_VISEME_4',
    'DISPID_SRRRecoContext', 'DISPID_SRStatus', 'SVP_20',
    'SPPHRASERULE', 'SRCS_Enabled', 'SREInterference',
    'SPVPRI_NORMAL', 'SAFT11kHz8BitMono',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SpeechRecoResult',
    'SPEI_FALSE_RECOGNITION', 'ISpeechRecoContext',
    'SpeechEngineProperties',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SpeechDataKey',
    'ISpeechLexiconWords', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SASCurrentSeekPosition', 'SAFT32kHz8BitStereo',
    'SPEI_MAX_TTS', 'SVSFVoiceMask', 'SAFT32kHz8BitMono',
    'SPSFunction', 'eLEXTYPE_RESERVED9', 'SRSActive',
    'SAFT11kHz8BitStereo', 'ISpRecoCategory',
    'SpeechPropertyAdaptationOn', 'SAFTGSM610_11kHzMono',
    'SpeechWordType', 'eLEXTYPE_PRIVATE9', 'DISPID_SOTDisplayUI',
    'STCAll', 'SPRECOCONTEXTSTATUS', 'DISPID_SRCVoicePurgeEvent',
    'SRESoundEnd', 'STCInprocServer', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRCState', 'SPRS_ACTIVE', 'DISPID_SpeechCustomStream',
    'SRSEIsSpeaking', 'DISPID_SVSLastResult', 'SP_VISEME_14',
    'ISpPhraseAlt', 'SRAORetainAudio', 'DISPID_SRRGetXMLResult',
    'ISpeechPhraseProperties', 'DISPID_SASCurrentDevicePosition',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCERecognition', 'IStream',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRCEFalseRecognition',
    'SpeechRuleAttributes', 'eLEXTYPE_PRIVATE5',
    'SGLexicalNoSpecialChars', 'DISPID_SDKEnumKeys',
    'SpeechRecoEvents', 'SpeechCategoryVoices',
    'SpTextSelectionInformation', 'SSSPTRelativeToCurrentPosition',
    'SPWORDPRONOUNCEABLE', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SGRs_NewEnum', 'DISPID_SRProfile', 'SPEI_SR_BOOKMARK',
    'DISPID_SRAudioInput', 'SAFT48kHz16BitStereo', 'SITooSlow',
    'SAFT22kHz16BitMono', 'SpeechUserTraining',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SMSSetData',
    'ISpeechWaveFormatEx', 'DISPID_SPRulesItem',
    'SDA_One_Trailing_Space', 'DISPID_SDKEnumValues',
    'SAFT8kHz8BitStereo', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechPhraseProperty', 'SpObjectTokenCategory', 'DISPID_SOTCId',
    'DISPID_SAEventHandle', 'DISPID_SFSOpen',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPRuleId',
    'DISPID_SPRuleConfidence', 'ISpeechLexiconWord',
    'ISpeechCustomStream', 'SPEI_RESERVED3', 'SAFTADPCM_22kHzMono',
    'SPWORDPRONUNCIATION', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRIsUISupported', 'SPCT_SLEEP', 'SPEI_TTS_PRIVATE',
    'STSF_CommonAppData', 'DISPID_SRCERecognitionForOtherContext',
    'SPGS_DISABLED', 'SPSEMANTICERRORINFO', 'DISPID_SPEsCount',
    'SREStreamEnd', 'SPSHORTCUTPAIRLIST', 'SpeechEngineConfidence',
    'ISpPhoneticAlphabetSelection', 'DISPID_SpeechXMLRecoResult',
    'ISpObjectTokenCategory', 'SP_VISEME_9', 'DISPID_SABIBufferSize',
    'SPBO_NONE', 'DISPID_SRDisplayUI', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechRecoContextEvents', 'SREPropertyNumChange',
    'DISPID_SRCEStartStream', 'DISPID_SLRemovePronunciation',
    'SECFNoSpecialChars', 'DISPID_SpeechPhraseProperties',
    'SP_VISEME_0', 'SRAInterpreter',
    'DISPID_SpeechObjectTokenCategory', 'SDTRule',
    'SSFMOpenReadWrite', 'SPRST_INACTIVE', 'SBOPause',
    'DISPID_SRRTimes', 'DISPID_SPIProperties', 'SRTEmulated',
    'SpeechAudioFormatGUIDText', 'ISpeechAudio', 'SPRS_INACTIVE',
    'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVWaitUntilDone',
    'Speech_Max_Pron_Length', 'DISPID_SRGCmdSetRuleState',
    'SP_VISEME_8', 'SPAS_PAUSE', 'SVEBookmark', 'LONG_PTR',
    'DISPID_SGRAddState', 'ISpEventSink', 'DISPID_SLGetWords',
    'SAFT16kHz16BitStereo', 'SpeechGrammarState',
    'DISPID_SWFEFormatTag', 'DISPID_SRCVoice',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVVoice',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SLPPartOfSpeech', 'STCInprocHandler', 'ISpeechDataKey',
    'SITooFast', 'SPCT_COMMAND', 'SpeechWordPronounceable',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SDKOpenKey',
    'SPRST_NUM_STATES', 'SPAO_NONE', 'DISPID_SVDisplayUI',
    'DISPID_SDKSetBinaryValue', 'DISPID_SpeechVoiceEvent',
    'ISpRecoGrammar', 'DISPID_SRGetPropertyNumber',
    'SPWT_PRONUNCIATION', 'DISPID_SASState', 'SREBookmark',
    'SPGRAMMARWORDTYPE', 'DISPID_SRCESoundStart', 'SP_VISEME_16',
    'DISPID_SGRsCommit', 'SPSERIALIZEDPHRASE',
    '_ISpeechRecoContextEvents', 'SWTDeleted', 'eLEXTYPE_PRIVATE13',
    'SPPS_Unknown', 'SPXMLRESULTOPTIONS', 'DISPID_SPPConfidence',
    'SDKLCurrentUser', 'SpeechVoiceSpeakFlags', 'DISPID_SFSClose',
    'SAFT12kHz8BitStereo', 'SpeechLexiconType', 'SVP_17',
    'ISpRecoContext2', 'DISPID_SVStatus', 'DISPID_SAStatus',
    'DISPID_SLGetGenerationChange', 'SDTReplacement', 'SGSEnabled',
    'SpeechAllElements', 'SPEI_SR_PRIVATE', 'SPPS_RESERVED1',
    'SPSHT_NotOverriden', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpeechXMLRecoResult', 'ISpeechGrammarRuleState',
    'ISpResourceManager', 'ISpRecognizer', 'SAFT11kHz16BitStereo',
    'SVP_14', 'SVP_19', 'DISPID_SPRuleName',
    'SpeechCategoryPhoneConverters', 'SWTAdded', 'SPPS_RESERVED2',
    'SPFM_CREATE_ALWAYS', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpResourceManager', 'DISPID_SRCEPropertyNumberChange',
    'ISpeechRecoResultDispatch', 'DISPID_SRSClsidEngine',
    'SVESentenceBoundary', 'SPPS_Noun', 'DISPID_SRRPhraseInfo',
    'SPWORDLIST', 'DISPID_SpeechLexiconPronunciation', 'WAVEFORMATEX',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRRAlternates',
    'SPEI_SR_AUDIO_LEVEL', 'SAFTADPCM_22kHzStereo',
    'SpeechCategoryRecoProfiles', 'SPAR_High',
    'DISPID_SPERequiredConfidence', 'eLEXTYPE_PRIVATE8',
    'DISPID_SPRuleFirstElement',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechGrammarWordType',
    'DISPID_SBSFormat', 'SAFT44kHz8BitMono', 'SAFTGSM610_22kHzMono',
    'DISPID_SVGetProfiles', 'SDA_Two_Trailing_Spaces', 'SP_VISEME_5',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPIEngineId',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SABIMinNotification',
    'DISPID_SRCreateRecoContext', 'SRESoundStart',
    'DISPID_SpeechRecoResult2', 'SDA_Consume_Leading_Spaces',
    '_RemotableHandle', 'SPEI_RECOGNITION', 'IEnumSpObjectTokens',
    'ISpNotifyTranslator', 'ISpeechObjectTokens',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SOTIsUISupported',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPPName',
    'DISPID_SOTCreateInstance', 'DISPID_SOTGetStorageFileName',
    'SpAudioFormat', 'SpeechStreamSeekPositionType',
    'SpInprocRecognizer', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechRecognizer',
    'SPEI_TTS_BOOKMARK', 'SPDKL_DefaultLocation', 'SPDKL_CurrentUser',
    'SPAUDIOSTATE', 'DISPID_SPILanguageId', 'DISPID_SPAsItem',
    'SPSModifier', 'ISpRecoResult', 'DISPID_SVGetVoices',
    'DISPID_SPRsCount', 'ISpPhrase', 'SVP_1', 'SPBO_TIME_UNITS',
    'SECHighConfidence', 'eLEXTYPE_PRIVATE6',
    'DISPID_SPEEngineConfidence', 'DISPID_SpeechFileStream',
    'SpLexicon', 'SECNormalConfidence', 'DISPID_SABIEventBias',
    'SVEViseme', 'ISpMMSysAudio', 'SAFT22kHz8BitStereo',
    'SPEI_PHONEME', 'SpMMAudioOut', 'SWPUnknownWordPronounceable',
    'DISPID_SGRSTRule', 'SBONone', 'SPEI_MAX_SR', 'SPSHT_Unknown',
    'SVEStartInputStream', 'SPPS_Function', 'DISPID_SOTSetId',
    'DISPID_SRRSaveToMemory', 'SAFT22kHz8BitMono',
    'SPSTREAMFORMATTYPE', 'SP_VISEME_17', 'eLEXTYPE_PRIVATE19',
    'SRAImport', 'DISPID_SVEPhoneme', 'DISPID_SLGetPronunciations',
    'DISPID_SRGRecoContext', 'DISPID_SGRsCount',
    'SpeechRecoProfileProperties', 'SpeechDiscardType',
    'DISPID_SOTCategory', 'SVP_12', 'SRADefaultToActive',
    'SWPUnknownWordUnpronounceable',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCBookmark', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRSetPropertyString', 'ISpeechGrammarRule',
    'SpFileStream', 'SRTSMLTimeout', 'DISPID_SRCEBookmark',
    'DISPID_SRGId', 'SpeechTokenKeyFiles', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRGDictationUnload', 'DISPID_SABufferNotifySize',
    'SpeechInterference', 'SPPHRASEELEMENT', 'eLEXTYPE_RESERVED4',
    'SpeechLoadOption', 'SDTLexicalForm', 'SPSVerb', 'SGRSTTEpsilon',
    'SPBINARYGRAMMAR', 'SpeechAudioState', 'SPPS_RESERVED3',
    'SPEI_END_INPUT_STREAM', 'SAFT24kHz16BitMono',
    'DISPID_SpeechRecognizerStatus', 'SPEI_SENTENCE_BOUNDARY',
    'SpSharedRecognizer', 'ISpStream', 'DISPID_SpeechVoice',
    'eLEXTYPE_PRIVATE3', 'SpeechVisemeType', 'DISPID_SPPChildren',
    'SAFT8kHz8BitMono', 'SPPS_NotOverriden', 'eLEXTYPE_RESERVED6',
    'SAFT12kHz8BitMono', 'DISPID_SRGSetWordSequenceData',
    'SP_VISEME_12', 'SVPAlert', 'SVP_18',
    'DISPID_SpeechPhraseAlternate', 'SAFTCCITT_uLaw_11kHzMono',
    'SP_VISEME_6', 'DISPID_SWFEBlockAlign', 'eLEXTYPE_PRIVATE4',
    'SAFT16kHz8BitMono', 'SPAS_STOP',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPAUDIOOPTIONS',
    'DISPID_SPRNumberOfElements', 'SpeechTokenKeyAttributes',
    'SPCONTEXTSTATE', 'SPINTERFERENCE_NOSIGNAL', 'SDKLCurrentConfig',
    'DISPID_SpeechLexiconWord', 'DISPID_SPAsCount',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTCDefault',
    'DISPID_SVSPhonemeId', 'SpeechStreamFileMode', 'DISPID_SLWsItem',
    'DISPID_SRCRetainedAudioFormat', 'SPSLMA', 'SpShortcut',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SLPType',
    'SPPS_Noncontent', 'IInternetSecurityManager', 'SpeechTokenKeyUI',
    'SASClosed', 'SPSERIALIZEDRESULT', 'SAFTADPCM_8kHzStereo',
    'eWORDTYPE_DELETED', 'DISPID_SRSCurrentStreamPosition',
    'SPEI_RESERVED5', 'DISPID_SRRecognizer', 'tagSPPROPERTYINFO',
    'SpeechAudioFormatType', 'DISPID_SPAs_NewEnum', 'ISpVoice',
    'SP_VISEME_19', 'SpeechGrammarTagDictation', 'DISPID_SMSALineId',
    'SSSPTRelativeToStart', 'DISPID_SVAudioOutput',
    'DISPID_SRGIsPronounceable', 'ISpeechPhraseElement',
    'SPRST_ACTIVE', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SGRSAddRuleTransition', 'SpeechAudioProperties',
    'SLOStatic', 'DISPID_SVIsUISupported',
    'SpeechPropertyResourceUsage', 'DISPID_SGRSTNextState',
    'SPVOICESTATUS', 'ISpeechPhraseReplacements',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRRTTickCount',
    'DISPID_SGRsCommitAndSave', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpDataKey', 'DISPID_SVSLastBookmarkId', 'SPCT_DICTATION',
    'SGDSInactive', 'SGDisplay', 'SAFT12kHz16BitMono', 'SPAS_RUN',
    'eLEXTYPE_PRIVATE18', 'ISpeechPhraseElements',
    'DISPID_SLWs_NewEnum', 'SPEI_START_INPUT_STREAM',
    'SAFTADPCM_11kHzMono', 'ISpPhoneticAlphabetConverter',
    'SAFT24kHz16BitStereo', 'SGDSActive', 'DISPID_SPELexicalForm',
    'DISPID_SRRSpeakAudio', 'SPINTERFERENCE_LATENCY_WARNING',
    '__MIDL_IWinTypes_0009', 'SP_VISEME_2',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SWFEExtraData',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SASetState',
    'SVF_None', 'DISPID_SpeechPhraseProperty', 'IEnumString',
    'SpeechVoiceCategoryTTSRate', 'SpeechVoicePriority',
    'DISPID_SGRsFindRule', 'DISPID_SAFGuid', 'SAFTADPCM_8kHzMono',
    'DISPID_SVEAudioLevel', 'SRSInactive', 'DISPID_SPAPhraseInfo',
    'DISPID_SPRsItem', 'DISPID_SOTs_NewEnum', 'SAFT24kHz8BitStereo',
    'SPEI_INTERFERENCE', 'SVP_5', 'SPBO_AHEAD', 'SpInProcRecoContext',
    'DISPID_SPCPhoneToId', 'SAFTCCITT_ALaw_44kHzMono',
    'STSF_LocalAppData', 'SPINTERFERENCE_NOISE',
    'DISPID_SPIRetainedSizeBytes', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPLO_STATIC', 'SpeechTokenContext', 'SpObjectToken',
    'DISPID_SPPId', 'DISPID_SVEventInterests', 'DISPID_SLPs_NewEnum',
    'SVSFParseSapi', 'SRADynamic', 'DISPID_SBSWrite',
    'DISPID_SADefaultFormat', 'DISPID_SpeechMemoryStream',
    'SPEI_REQUEST_UI', 'ISpObjectWithToken', 'SP_VISEME_13',
    'DISPID_SGRsItem', 'SpStreamFormatConverter', 'SVSFlagsAsync',
    'Speech_StreamPos_Asap', 'SDKLDefaultLocation',
    'SPWAVEFORMATTYPE', 'SPDKL_LocalMachine', 'SPGS_ENABLED',
    'SRERequestUI', 'DISPID_SLGenerationId', 'DISPID_SLWLangId',
    'DISPID_SRSSupportedLanguages', 'SpeechRecognizerState',
    'DISPID_SLWWord', 'DISPID_SPEDisplayAttributes',
    'IInternetSecurityMgrSite', 'SPSUnknown', 'DISPID_SRGCommit',
    'SPINTERFERENCE_TOOQUIET', 'SFTInput', 'SREPhraseStart',
    'DISPID_SWFEAvgBytesPerSec', 'eLEXTYPE_PRIVATE14',
    'DISPID_SVSLastStreamNumberQueued', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPRs_NewEnum', 'DISPID_SVSyncronousSpeakTimeout',
    'SECFEmulateResult', 'DISPID_SGRSTType',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPPS_Interjection',
    'tagSTATSTG', 'SREStateChange', 'SpCompressedLexicon',
    'DISPID_SPIEnginePrivateData', 'ISpXMLRecoResult',
    'SPEI_SOUND_START', 'ISpeechRecoResult2', 'SPAUDIOBUFFERINFO',
    'SAFT44kHz8BitStereo', 'DISPIDSPTSI_SelectionLength',
    'SAFTADPCM_44kHzStereo', 'SPVPRI_ALERT', 'SPLOADOPTIONS',
    'DISPID_SpeechAudio', 'SpeechVisemeFeature',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVP_11', 'SITooLoud',
    'SPAR_Unknown', 'DISPIDSPTSI_ActiveLength', 'SECFDefault',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SGRSTsItem',
    'DISPID_SPPs_NewEnum', 'SPEI_VISEME',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SGRSRule', 'DISPID_SRCERequestUI', 'DISPID_SRIsShared',
    'SWPKnownWordPronounceable', 'DISPID_SPRuleChildren',
    'SpeechRunState', 'SpeechGrammarTagWildcard',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SVSInputSentencePosition',
    'SAFT32kHz16BitMono', 'ISequentialStream', 'SPFM_OPEN_READONLY',
    'SRCS_Disabled', 'DISPID_SDKDeleteKey', 'SP_VISEME_21',
    'DISPID_SPERetainedStreamOffset', 'ISpRecognizer3',
    'ISpeechLexicon', 'SPEVENTSOURCEINFO', 'SSTTDictation',
    'SVSFParseMask', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SLPLangId', 'DISPID_SpeechPhraseElements',
    'DISPID_SPRulesCount', 'DISPID_SVSpeak', 'DISPID_SPIGrammarId',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPEsItem',
    'SAFTNoAssignedFormat', 'SAFT16kHz16BitMono', 'DISPID_SPPParent',
    'DISPID_SpeechVoiceStatus', 'DISPID_SVSInputWordPosition',
    'SPSInterjection', 'SAFTCCITT_ALaw_8kHzMono', 'ISpRecognizer2',
    'DISPID_SAFType', 'SpeechRegistryUserRoot', 'SPEI_RESERVED2',
    'DISPID_SRRTOffsetFromStart', 'SpCustomStream',
    'DISPID_SLAddPronunciation', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPIStartTime', 'SPBOOKMARKOPTIONS', 'SpNotifyTranslator',
    'SPEI_WORD_BOUNDARY', 'SPPARTOFSPEECH', 'SPBO_PAUSE', 'SVSFIsXML',
    'SVEPrivate', 'SVSFIsNotXML', 'SpNullPhoneConverter',
    'ISpeechPhraseAlternate', 'DISPID_SMSADeviceId',
    'SpeechRetainedAudioOptions', 'SGRSTTTextBuffer', 'SPFM_CREATE',
    'DISPID_SLPPhoneIds', 'UINT_PTR', 'SPPS_Verb',
    'DISPID_SVAudioOutputStream', 'DISPID_SOTCSetId', 'SRAONone',
    'DISPID_SDKSetLongValue', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SBSSeek', 'SAFTNonStandardFormat',
    'SAFTCCITT_uLaw_8kHzMono', 'SPCT_SUB_DICTATION', 'DISPID_SVSkip',
    'DISPID_SPRuleEngineConfidence', 'SpeechCategoryAppLexicons',
    'SDTPronunciation', 'DISPID_SRCPause', 'SECFIgnoreCase',
    'DISPID_SGRInitialState', 'DISPIDSPTSI_ActiveOffset',
    'ISpProperties', 'ISpeechRecoResultTimes',
    'DISPID_SPEAudioTimeOffset', 'SPDKL_CurrentConfig',
    'SpeechRecognitionType', 'SPWORD',
    'ISpeechTextSelectionInformation', 'ISpPhoneConverter', 'SVP_9',
    'SPSEMANTICFORMAT', 'DISPID_SpeechLexiconProns',
    'DISPID_SGRSAddWordTransition', 'SVEAllEvents',
    'SREPropertyStringChange', 'DISPID_SPPFirstElement',
    'SpeechEmulationCompareFlags', 'DISPID_SVGetAudioOutputs',
    'DISPID_SVSInputWordLength', 'DISPID_SRGCmdLoadFromMemory',
    'SECFIgnoreKanaType', 'ISpStreamFormat', 'SGRSTTWord',
    'SPXRO_SML', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SVSCurrentStreamNumber', 'SVSFPurgeBeforeSpeak',
    'SREAdaptation', 'DISPID_SpeechBaseStream', 'SPWF_INPUT',
    'DISPID_SGRId', 'DISPID_SRSNumberOfActiveRules',
    'SSFMCreateForWrite', 'ISpeechFileStream',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_MORPHOLOGY',
    'SECFIgnoreWidth', 'ISpLexicon', 'DISPID_SOTGetDescription',
    'ISpeechPhraseInfo', 'SpeechPropertyLowConfidenceThreshold',
    'eLEXTYPE_PRIVATE1', 'DISPID_SVSLastBookmark',
    'SSSPTRelativeToEnd', 'SGSDisabled', 'DISPID_SpeechLexicon',
    'SVEPhoneme', 'SpeechBookmarkOptions', 'ISpSerializeState',
    'SPEI_PROPERTY_STRING_CHANGE', 'SFTSREngine', 'SGLexical',
    'SVP_10', 'Speech_Default_Weight',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPRules_NewEnum',
    'SPRECORESULTTIMES', 'DISPID_SPPValue', 'DISPID_SPPsItem',
    'DISPID_SGRSTsCount', 'DISPID_SpeechPhraseReplacements',
    'SRTExtendableParse', 'SREAllEvents', 'SPEI_UNDEFINED',
    'DISPID_SRState', 'SDKLLocalMachine', 'SDTAudio',
    'DISPID_SRCResume', 'SpPhoneticAlphabetConverter', 'SPSHT_EMAIL',
    'SpeechTokenShellFolder', 'SVEVoiceChange', 'DISPID_SGRSTWeight',
    'SPPS_RESERVED4', 'DISPID_SOTsCount', 'SREPrivate',
    'SGDSActiveWithAutoPause', 'SAFTText', 'SPXRO_Alternates_SML',
    'SASRun', 'DISPID_SOTId', 'SPAR_Low', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPEDisplayText', 'DISPID_SpeechObjectTokens',
    'SREAudioLevel', 'SpeechAudioVolume', 'DISPID_SAFGetWaveFormatEx',
    'SRERecoOtherContext', 'DISPID_SRCRetainedAudio', 'ISpShortcut',
    'DISPID_SRCEInterference', 'SPVISEMES', 'DISPID_SPIReplacements',
    'SPINTERFERENCE', 'SpeechVoiceSkipTypeSentence', 'SVSFIsFilename',
    'DISPID_SVEViseme', 'DISPID_SPPsCount',
    'DISPID_SRCCmdMaxAlternates', 'SAFT32kHz16BitStereo',
    'SPWF_SRENGINE', 'ISpRecoGrammar2', 'SAFTCCITT_uLaw_8kHzStereo',
    'SRERecognition', 'DISPID_SpeechObjectToken', 'SGPronounciation',
    'SVPOver', 'DISPID_SpeechPhraseRules', 'SPAO_RETAIN_AUDIO',
    'SPINTERFERENCE_TOOFAST', 'SPEI_SOUND_END',
    'SRSInactiveWithPurge', 'DISPID_SBSRead', 'SVP_3',
    'DISPID_SRGetRecognizers', 'SITooQuiet',
    'DISPID_SOTMatchesAttributes', 'SVP_6', 'ISpeechBaseStream',
    'SpWaveFormatEx', 'SASPause', 'SPPS_SuppressWord',
    'SpeechSpecialTransitionType', 'SP_VISEME_7',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SOTsItem',
    'DISPID_SPAStartElementInResult', 'SAFT11kHz16BitMono',
    'SPAUDIOSTATUS', 'SPCATEGORYTYPE', 'SPEI_HYPOTHESIS',
    'SpeechTokenIdUserLexicon', 'SPVPRI_OVER', 'SPPHRASEREPLACEMENT',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SWFEBitsPerSample',
    'ISpeechPhoneConverter', 'DISPID_SMSAMMHandle',
    'DISPID_SGRsDynamic', 'SREHypothesis', 'SGSExclusive',
    'eLEXTYPE_USER', 'SVPNormal', 'SVSFUnusedFlags',
    'DISPID_SRCRecognizer', 'DISPID_SRCESoundEnd',
    'DISPID_SRRTLength', 'DISPID_SRSetPropertyNumber',
    'DISPID_SLPsCount', 'SVSFNLPSpeakPunc', 'DISPID_SRRTStreamTime',
    'SVF_Emphasis', 'STSF_AppData', 'DISPID_SGRSTText',
    'SpeechCategoryRecognizers', 'DISPID_SRCEAdaptation', 'SASStop',
    'ISpeechGrammarRules', 'SPRECOSTATE', 'SpeechCategoryAudioIn',
    'SRTAutopause', 'SpeechMicTraining', 'SpeechRecoContextState',
    'SRARoot', 'SP_VISEME_3', 'SPPS_LMA', 'SINone',
    'DISPID_SWFEChannels', 'tagSPTEXTSELECTIONINFO', 'SPSHORTCUTTYPE',
    'SGRSTTRule', 'eLEXTYPE_PRIVATE17', 'SPRULE',
    'SAFT44kHz16BitStereo', 'SAFTCCITT_ALaw_11kHzMono',
    'SP_VISEME_10', 'DISPID_SLWsCount', 'SVSFParseSsml',
    'DISPID_SABufferInfo', 'DISPID_SRCRequestedUIType',
    'ISpeechAudioBufferInfo', 'ISpeechMMSysAudio',
    'DISPID_SPEPronunciation', 'SPEI_END_SR_STREAM', 'SPPS_Modifier',
    'SRTReSent', 'DISPID_SGRClear', 'SpVoice', 'DISPID_SGRsAdd',
    'eLEXTYPE_RESERVED10', 'SAFT44kHz16BitMono', 'ISpeechObjectToken',
    'SPRS_ACTIVE_USER_DELIMITED', 'STSF_FlagCreate', 'SPGRAMMARSTATE',
    'DISPID_SRGState', 'SPEI_RESERVED6', 'DISPID_SASNonBlockingIO',
    'SPEI_PHRASE_START', 'DISPID_SpeechRecoResultTimes', 'SLTUser',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SGRAttributes',
    'DISPID_SRRAudio', 'SPINTERFERENCE_NONE', 'SPADAPTATIONRELEVANCE',
    'SpPhoneConverter', 'DISPID_SRCCreateGrammar',
    'DISPID_SPPEngineConfidence', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SVPriority', 'DISPID_SPRDisplayAttributes', 'SLODynamic',
    'SAFTGSM610_44kHzMono', 'SpeechDataKeyLocation',
    'DISPID_SGRSTPropertyName', 'SPEVENT',
    'DISPID_SPRuleNumberOfElements', 'SpeechDictationTopicSpelling',
    'DISPID_SRCEEndStream', 'DISPID_SRGRules',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechGrammarRules',
    'SPEI_VOICE_CHANGE', 'SLTApp', 'DISPID_SVEStreamStart',
    'DISPID_SDKGetStringValue', 'DISPID_SPRText',
    'DISPID_SVSpeakStream', 'SVEAudioLevel', 'SRTStandard',
    'ISpeechMemoryStream', 'eLEXTYPE_PRIVATE2', 'DISPID_SPIGetText',
    ...
    'SAFTADPCM_44kHzMono', 'eLEXTYPE_PRIVATE16',
    'SGDSActiveUserDelimited', 'ISpeechRecognizerStatus',
    'SVEEndInputStream', 'eLEXTYPE_RESERVED8', 'SPSHORTCUTPAIR',
    'DISPID_SVPause', 'DISPID_SASFreeBufferSpace', 'SPAR_Medium',
    'SPPROPERTYINFO', 'DISPID_SGRSTransitions', 'SPEI_RESERVED1',
    'SRAExport', 'DISPID_SREmulateRecognition',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPIElements',
    'SpeechAddRemoveWord', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPEAudioSizeTime', 'DISPID_SpeechLexiconWords',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVRate', 'SPCT_SUB_COMMAND',
    'SPDATAKEYLOCATION', 'SPWT_DISPLAY', 'DISPID_SLWType',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechPhraseInfo', 'SAFTExtendedAudioFormat',
    'SAFT8kHz16BitStereo', 'eLEXTYPE_PRIVATE12',
    'SpeechAudioFormatGUIDWave', 'SPEI_RECO_STATE_CHANGE',
    'SAFTTrueSpeech_8kHz1BitMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRSCurrentStreamNumber', 'SPGS_EXCLUSIVE',
    'DISPID_SRRAudioFormat', 'SPPHRASEPROPERTY',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechCategoryAudioOut', '_ISpeechVoiceEvents',
    'eLEXTYPE_PRIVATE15', 'SVP_15', 'SAFT48kHz8BitMono',
    'ISpeechRecognizer', 'SAFT48kHz16BitMono',
    'SAFTCCITT_ALaw_22kHzMono', 'SVP_2', 'SINoise', 'DISPID_SVEWord',
    'ISpeechLexiconPronunciation', 'eLEXTYPE_USER_SHORTCUT',
    'ISpRecoContext', 'DISPID_SPANumberOfElementsInResult',
    'ISpeechObjectTokenCategory', 'ISpeechResourceLoader',
    'DISPID_SPIRule', 'SP_VISEME_18', 'DISPID_SGRAddResource',
    'SPSMF_UPS', 'SAFT12kHz16BitStereo', 'SVSFParseAutodetect',
    'SPPHRASE', 'SP_VISEME_15', 'ISpAudio', 'SPEI_MIN_TTS', 'SVP_16',
    'DISPID_SpeechPhoneConverter', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVEStreamEnd', 'DISPID_SRGDictationLoad',
    'DISPID_SDKCreateKey', 'DISPID_SDKDeleteValue',
    'DISPID_SRCEAudioLevel', 'SPCS_DISABLED',
    'DISPID_SRGDictationSetState', 'SpMemoryStream', 'SVP_13',
    'DISPID_SLPSymbolic', 'SPSSuppressWord',
    'DISPID_SpeechPhraseRule', 'SRSEDone', 'SPEI_START_SR_STREAM',
    'Speech_Max_Word_Length', 'SPCS_ENABLED', 'DISPID_SCSBaseStream',
    'DISPID_SGRName', 'SDTProperty', 'DISPID_SDKGetlongValue'
]

_check_version('1.2.0', 1683289218.955045)
